...
class _EditGenderScreenState extends State<EditGenderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> genders =
        Provider.of<SocialProvider>(context,listen: true).genders;
      ...
      Scaffold(
        appBar: AppBar(
          ...
          actions: [
            TextButton(
              onPressed: () {
                userProvider.updateBasicInfoGender(gender)
                    .then((value){
          ...
          child: Column(
            children: [
              ...
              ListView.separated(
                ...
                shrinkWrap: true,
                itemBuilder: (context, index) => buildRadioButton(genders[index]),
